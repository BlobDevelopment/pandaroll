...
var newCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if len(args) == 0 {
			return logger.Fatal("Description required! Usage: pandaroll new <description>")
		}
		...
		if err != nil {
			return logger.Fatalf("Failed to create migrations directory! Error: %s", err.Error())
		}
		...
		if err != nil {
			return logger.Fatalf("Failed to ceate migration file! Error: %s", err.Error())
		}
